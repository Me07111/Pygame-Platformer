...
class MainMenu:
    ...
    def update(self,delta,gametime,levelHandler):
        ...
        renderText(self.screen,self.winnerText,"timesnewroman",scaleValue(self.height30),pygame.Color(0,255,0),scaleRect(self.height,(self.width/2 - 170,self.height/2 - 200)))
