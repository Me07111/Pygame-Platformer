...
class Button:
    def __init__(self,pos,size,text : str,color = pygame.Color(255,255,255),textSize : int = 20,textColor = pygame.Color(0,0,0),hoveredColor = pygame.Color(0,0,0,50),pressedColor = pygame.Color(0,0,0),cooldown : float = 0.1):
        super().__init__()
