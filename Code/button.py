...
class Button():
    def __init__(self,pos,size,text,color = pygame.Color(255,255,255),textSize = 20,textColor = pygame.Color(0,0,0),hoveredColor = pygame.Color(0,0,0,100),pressedColor = pygame.Color(0,0,0)):
        super().__init__()
